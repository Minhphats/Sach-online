...
namespace Lab03_4.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult DangKy(FormCollection collection,KHACHHANG kh)
        {
            ...
            else if (data.KHACHHANG.SingleOrDefault(n => n.TenDN == tendn) != null)
            {
                ViewBag.Thongbao = "Tên đăng nhập đã tồn tại";
            }
            else if (data.KHACHHANG.SingleOrDefault(n => n.Email == email) != null)
            {
        ...
        [HttpGet] public ActionResult DangNhap()
        {
            return View();
        }
        [HttpPost]
        public ActionResult DangNhap(FormCollection collection)
        {
            ...
            {
                KHACHHANG kh = data.KHACHHANG.SingleOrDefault(n => n.TenDN == sTenDN && n.MatKhau == sMatKhau);
                if (kh != null)
                {
